            ...
            <div class="container">
                         <?php
                                 if(!empty($_POST['id'])){
                                            ...
                                            mysql_query("UPDATE producto SET status='$status',cliente_tmp='',fech_entrega='',fecha_in='' WHERE id='$id' ");
                                                                                                                                                                                                                         
                                            echo mensajes('Servicio Entregado con Exito','verde');
                                    }
                            ?>                                      
            <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title" align="center"><b>Control de Servicios</b></h4>
                            <table id="datatable-buttons" class="table table-striped">
                                ...
                                <tbody>
                                    <?php 
                                        $ss=mysql_query("SELECT * FROM producto WHERE status ='OCUPADA' AND control='s'");
                                        while($rr=mysql_fetch_array($ss)){											
                                            ...
                                            if ($rr['fech_entrega'] == $fecha) {
                                                $color='success';
                                                           }
                                            elseif ($rr['fech_entrega'] < $fecha) {
                                                $color='danger';
                                                           }
                                            else
                                            {
                                    ...
                                    <tr class="<?php echo $color; ?>">                                       
                                        ...
                                        <td><?php echo $oTipo->consultar('nombre');  ?></td>                                       
                               			<td><?php echo $control; ?></strong></td>
                                        <td><?php echo fecha($rr['fecha_in']); ?></td>                                    
                                        <td><?php echo fecha($rr['fech_entrega']).' '.$hora; ?></td>                                    
                                        <td align="center">
                                                <div  class="btn-group btn-group m-b-10">
                                                    <a href="#editar<?php echo $rr['id']; ?>" class="btn btn-primary btn-xs waves-effect waves-light" role="button" data-toggle="modal"> <i class="fa  fa-pencil-square-o"></i> Dar de Alta</a>
                                                </div>
                                            <?php 
                                                ...
                                                ?>                                       
                                                <div  class="btn-group btn-group m-b-10">
                                                    <a href="#editar<?php echo $rr['id']; ?>" class="btn btn-danger btn-xs waves-effect waves-light" role="button" data-toggle="modal"> <i class="fa  fa-pencil-square-o"></i> <?php echo $rr['status']; ?></a>
                                                </div>
                                            <?php }} ?>
                                        </td>
                                    </tr>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                ...
                                                                <h4 class="modal-title" align="center">DAR DE ALTA SERVICIO</h4>
                                                            </div>
