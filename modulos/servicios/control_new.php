            ...
            <div class="container">
                         <?php
                                 if(!empty($_POST['id'])){
                                            ...
                                            echo mensajes('Habitacion Entrega con Exito','verde');
                                    }
                            ?>                                      
            <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title" align="center"><b>Control de Habitaciones</b></h4>
                            <table id="datatable-buttons" class="table table-striped">
                                ...
                                <tbody>
                                    <?php 
                                        $ss=mysql_query("SELECT * FROM producto WHERE control='s' and status ='OCUPADA'");
                                        while($rr=mysql_fetch_array($ss)){											
                                            ...
                                            $oCliente=new Consultar_Cliente($rr['cliente_tmp']);
                                    ...
                                    <tr class="<?php echo $color; ?>">                                       
                                        ...
                                        <td><?php echo fecha($rr['fech_entrega']); ?></td>                                    
                                        <td align="center">
