                        ...
                        <div class="message-box">
                            ...
                            <div class="buttons-con">
                                <div class="action-link-wrap">
                                    <a onclick="history.back(-1)" class="btn btn-custom btn-primary waves-effect waves-light m-t-20">Regresar</a>
                                    <a href="../php_cerrar.php" class="btn btn-custom btn-primary waves-effect waves-light m-t-20">Reiniciar</a>
                                </div>
                            </div>
                        </div>
                    </div>
