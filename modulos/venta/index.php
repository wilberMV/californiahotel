                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $rr['cel']; ?></td>
                                          <td align="center">
                                            ...
                                            <?php if(permisos($_SESSION['seguridad'.$_SESSION['cod_user']],'Venta','1')==true){ ?>                                       
                                                <div  class="btn-group btn-group m-b-10">
                                                    <a href="admin.php?i=<?php echo claves($rr[0]); ?>" class="btn btn-danger btn-xs waves-effect waves-light" role="button" data-toggle="tooltip" data-placement="top" data-original-title="Asignar Servicio" > <i class="fa fa-mail-forward"></i></a>
                                                </div>
                                            <?php } ?>
                                        </td>
                                    </tr>
